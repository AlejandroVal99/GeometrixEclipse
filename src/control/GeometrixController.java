...
public class GeometrixController implements OnMessageListener {
	...
	public void OnUserReceived(String player, User user) {
		...
		case "player1":
			...
			case 0:
				player1 = new Player(user.getName(), new Triangletrix(true,user.getName(),p1imageN0,app));
				break;
			case 1:
				player1 = new Player(user.getName(), new Diamondrox(true,user.getName(),p1imageN1,app));
				break;
			case 2:
				player1 = new Player(user.getName(), new Circletlex(true,user.getName(),p1imageN2,app));
				break;
			case 3:
				player1 = new Player(user.getName(), new Squarlux(true,user.getName(),p1imageN3,app));
				break;
		...
		case "player2":
			switch(user.getTspaceship()) {
			case 0:
				player2 = new Player(user.getName(), new Triangletrix(false,user.getName(),p2imageN0,app));
				break;
			case 1:
				player2 = new Player(user.getName(), new Diamondrox(false,user.getName(),p2imageN1,app));
				break;
			case 2:
				player2 = new Player(user.getName(), new Circletlex(false,user.getName(),p2imageN2,app));
				break;
			case 3:
				player2 = new Player(user.getName(), new Squarlux(false,user.getName(),p2imageN3,app));
				break;
