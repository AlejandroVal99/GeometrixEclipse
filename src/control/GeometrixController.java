...
public class GeometrixController implements OnMessageListener {
	...
	private PImage bulletOrange,bulletOrange2,blueBullet,blueBullet2,bulletPurple,bulletGreen,bulletGreen2,superBulletNaranja;
	...
	public void OnUserReceived(String player, User user) {
		...
		case "player1":
			...
			case 0:
				player1 = new Player(user.getName(), new Triangletrix(true,user.getName(),p1imageN0,n0Sel,app,100,blueBullet,superBulletNaranja));
				break;
			case 1:
				...
				break;
			case 2:
				player1 = new Player(user.getName(), new Circletlex(true,user.getName(),p1imageN2,n2Sel,app,30,bulletPurple,superBulletNaranja));
				break;
			case 3:
				player1 = new Player(user.getName(), new Squarlux(true,user.getName(),p1imageN3,n3Sel,app,80,bulletGreen,superBulletNaranja));
				break;
		...
		case "player2":
			switch(user.getTspaceship()) {
			case 0:
				player2 = new Player(user.getName(), new Triangletrix(false,user.getName(),p2imageN0,n0Sel,app,80,blueBullet2,superBulletNaranja));
				break;
			case 1:
				player2 = new Player(user.getName(), new Diamondrox(false,user.getName(),p2imageN1,n1Sel,app,100,bulletOrange2,superBulletNaranja));
				break;
			case 2:
				player2 = new Player(user.getName(), new Circletlex(false,user.getName(),p2imageN2,n2Sel,app,100,bulletPurple,superBulletNaranja));
				break;
			case 3:
				player2 = new Player(user.getName(), new Squarlux(false,user.getName(),p2imageN3,n3Sel,app,100,bulletGreen2,superBulletNaranja));
				break;				
			}
			break;
		}
